...
To customize this script, replace the placeholders with your actual information:
- "your_bucket_name_here": Replace this with the name of your AWS S3 bucket.
- "your_directory_here": Replace this with the directory in your bucket where you want the files to be uploaded. This should be the same in all three places it appears in the script.
*)
